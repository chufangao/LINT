...
def get_icdcode_lst(input_file):
...
def collect_all_icdcodes(input_file):
	code_lst = get_icdcode_lst(input_file)
...
def build_icdcode2ancestor_dict(pkl_file="data/icdcode2ancestor_dict.pkl", input_file='data/raw_data.csv'):
	if os.path.exists(pkl_file):
		icdcode2ancestor = pickle.load(open(pkl_file, 'rb'))
		return icdcode2ancestor 
	all_code = collect_all_icdcodes(input_file)
...
def collect_all_code_and_ancestor(pkl_file="data/icdcode2ancestor_dict.pkl", input_file='data/raw_data.csv'):
	icdcode2ancestor = build_icdcode2ancestor_dict(pkl_file, input_file)
